...
//нажний слайдер
  ...
  return (
    <div>
              ...
              <img className='right-arrow' src={rightArrow} onClick={prevSlide} alt='right'/>
              <img className='left-arrow' src={leftArrow} onClick={nextSlide} alt='left'/>
        ...
        return (
          ...
          >
            ...
            <img src={process.env.PUBLIC_URL + `/image/banana-apricot/${hoodies}${slide.image}${!pocket ? 'all' : 'hood-only'}.png`} alt='image111' className='image' />
              ...
              <img className='right-arrow2' src={rightArrow} onClick={()=>{setPocket(!pocket)}} alt='right'/>
              <img className='left-arrow2' src={leftArrow} onClick={()=>{setPocket(!pocket)}} alt='left'/>
               
              <div className='containerDots'>
              <img className='colorButton' src={leftArrow2} onClick={prevColor} alt='left'/>
              <span className='text'>Цвет элементов</span>
              <img className='colorButton' src={rightArrow2} onClick={nextColor} alt='right'/>
                <div className='dots'>
